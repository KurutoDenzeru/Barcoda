...
export const QRCodeGenerator = () => {
  ...
  const [imageInputType, setImageInputType] = React.useState<"file" | "url">("file");  const [showAdvanced, setShowAdvanced] = React.useState(false);  const qrRef = React.useRef<HTMLDivElement>(null);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {/* Preview Section */}
      <div className="order-1 lg:order-2 flex flex-col items-center justify-center p-6 bg-muted/30 rounded-2xl border border-border/50 min-h-[300px]">
        <div
      ...
      {/* Settings Section */}
      <div className="order-2 lg:order-1 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto pr-2">
        {/* Content */}
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label>Image Margin: {settings.imageMargin}px</Label>
            <Slider
              value={[settings.imageMargin]}
              onValueChange={([v]) => updateSettings("imageMargin", v)}
              min={0}
              max={30}
              className="mt-2"
            />
